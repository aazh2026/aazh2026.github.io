...
写完一篇文章后，最后一遍 review 时问自己：

- **同系列有没有前后呼应的早期文章？** 在"延伸阅读"区加链接 —— 这是 SEO + 系列粘性最便宜的动作。
- **这篇文章里提到的概念，是否在其他文章里详细展开过？** 顺手链过去；不要在每篇文章里重复展开同一概念。
- **新概念是这一篇首创的吗？** 如果是，回链之前所有引用过它的文章，让"思想脉络"显式可见。

**不要做**：

- 不要为 SEO 强行插链接 —— 一段连续阅读被断 3 次以上会逼走读者
- 不要在新文章里链同一天发布的文章 —— 读者不会跳来跳去
- 不要把内部链接做成"延伸阅读"清单里 10+ 条 —— 3-5 条是上限，超过变成目录
