...
**[语义缓存的经济学：如何用记忆节省 90% 的 API 成本](/posts/2025-01-25-semantic-caching/)**
...
**[上下文窗口的"虚拟内存"化：当 RAG 成为分页机制](/posts/2025-01-29-virtual-memory-rag/)**
...
**[为什么 Context Engineering 比 Prompt Engineering 更重要](/posts/2025-04-09-context-engineering/)**
...
**[为什么你的 AI 助手越用越笨？](/posts/2025-04-10-context-rot/)**
...
**[Context Layer 架构：企业级 AI 系统的上下文分层设计与实现](/posts/2025-02-23-context-layer-architecture/)**
...
| 阶段 | 你在做 | 锚点文章 | 投入回报 |
|------|--------|----------|---------|
| L1 | 算语义缓存的 ROI | [语义缓存](/posts/2025-01-25-semantic-caching/) | 月省 30-50% 成本 |
| L2 | 设计分页 RAG | [虚拟内存 RAG](/posts/2025-01-29-virtual-memory-rag/) | 延迟降一个数量级 |
| L3 | 把 Context 当产品 | [Context Engineering 入门](/posts/2025-04-09-context-engineering/) | 准确率跳一个台阶 |
| L4 | 防止 Context 腐烂 | [Context Rot](/posts/2025-04-10-context-rot/) | 减少"AI 突然变笨"事故 |
| L5 | 企业级 Context Layer | [Context Layer 架构](/posts/2025-02-23-context-layer-architecture/) | 跨项目复用组织知识 |
...
1. [语义缓存的经济学](/posts/2025-01-25-semantic-caching/) — L1 缓存复用
2. [上下文窗口的"虚拟内存"化](/posts/2025-01-29-virtual-memory-rag/) — L2 语义检索
3. [为什么 Context Engineering 比 Prompt Engineering 更重要](/posts/2025-04-09-context-engineering/) — L3 主动喂 Context
4. [为什么你的 AI 助手越用越笨？](/posts/2025-04-10-context-rot/) — L4 防腐烂
5. [Context Layer 架构](/posts/2025-02-23-context-layer-architecture/) — L5 企业级分层
