...
<object data="/assets/images/2025-04-21-product-intent-definition-03-prd-vs-intent.svg" type="image/svg+xml" width="100%" aria-label="PRD 的局限性" role="img"></object>
...
<object data="/assets/images/2025-04-21-product-intent-definition-01-intent-dimensions.svg" type="image/svg+xml" width="100%" aria-label="五维意图框架" role="img"></object>
...
<object data="/assets/images/2025-04-21-product-intent-definition-02-intent-hierarchy.svg" type="image/svg+xml" width="100%" aria-label="Product Intent 的层级结构" role="img"></object>
