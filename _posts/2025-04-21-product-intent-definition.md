...
```mermaid
flowchart TB
    L1["Level 1: 战略意图 (Strategic Intent)
    '成为最懂用户的电商平台'"]
    L2["Level 2: 产品意图 (Product Intent)
    '通过个性化推荐提升用户发现和购买效率'"]
    L3["Level 3: 功能意图 (Feature Intent)
    '首页个性化推荐模块：在100ms内展示5个相关商品'"]
    L4["Level 4: 实现意图 (Implementation Intent)
    ...
    style L1 fill:#fef3c7,stroke:#d97706,stroke-width:3px
