...
tags: [Executable PRD, 需求工程, AI-Native软件工程, 产品文档, 范式转移]
...
<object data="/assets/images/2025-04-14-executable-prd-01-compilation-pipeline.jpg" type="image/jpeg" width="100%" aria-label="编译：从PRD到可运行系统" role="img"></object>
*图 1：Executable PRD 编译流程——一份 YAML 规格说明通过 Spec Compiler 生成数据库 Schema、API 定义、业务逻辑、UI 组件、测试用例和文档，实现单一真相源到多份工件的高效转化。*

<object data="/assets/images/2025-04-14-executable-prd-02-workflow.jpg" type="image/jpeg" width="100%" aria-label="编译：从PRD到可运行系统" role="img"></object>
