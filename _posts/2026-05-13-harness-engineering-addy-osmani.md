...
<object data="/assets/images/2026-05-13-harness-engineering-addy-osmani-00-hero.svg" type="image/svg+xml" width="100%" aria-label="2026-05-13-harness-engineering-addy-osmani-00-hero 图示" role="img"></object>
...
<object data="/assets/images/2026-05-13-harness-engineering-addy-osmani-01-arch.svg" type="image/svg+xml" width="100%" aria-label="Harness 到底是什么" role="img"></object>
...
<object data="/assets/images/2026-05-13-harness-engineering-addy-osmani-02-six-pillars.svg" type="image/svg+xml" width="100%" aria-label="从行为倒推 harness 设计" role="img"></object>
