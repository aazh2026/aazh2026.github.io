...
<object data="/assets/images/2025-05-14-domain-terminology-governance-01-stack.svg" type="image/svg+xml" width="100%" aria-label="三层术语架构（插图）" role="img"></object>
...
<object data="/assets/images/2025-05-14-domain-terminology-governance-02-ai-alignment.svg" type="image/svg+xml" width="100%" aria-label="TypeScript/JavaScript（插图）" role="img"></object>
