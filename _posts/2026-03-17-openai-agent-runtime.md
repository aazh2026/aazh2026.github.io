...
tags: [AI-Native软件工程, Agent, Runtime, OpenAI, Architecture]
...
<object data="/assets/images/2026-03-17-openai-agent-runtime-01-stack.svg" type="image/svg+xml" width="100%" aria-label="架构概览：三层设计" role="img"></object>
...
<object data="/assets/images/2026-03-17-openai-agent-runtime-02-arch.svg" type="image/svg+xml" width="100%" aria-label="功能边界" role="img"></object>
...
<object data="/assets/images/2026-03-17-openai-agent-runtime-03-arch.svg" type="image/svg+xml" width="100%" aria-label="冷启动优化" role="img"></object>
...
<object data="/assets/images/2026-03-17-openai-agent-runtime-01-arch.svg" type="image/svg+xml" width="100%" aria-label="安全层次" role="img"></object>
