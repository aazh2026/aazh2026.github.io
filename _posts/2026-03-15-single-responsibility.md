...
```mermaid
flowchart TB
    subgraph God["万能 Agent (反模式)"]
        S["搜索/邮件"]
        A["分析/日历"]
        W["写作/文件"]
    end
    
    style God fill:#fee2e2,stroke:#dc2626,stroke-width:2px
    style S fill:#fed7aa,stroke:#ea580c
    style A fill:#fed7aa,stroke:#ea580c
...
flowchart TB
    ...
    style O fill:#fef3c7,stroke:#d97706,stroke-width:3px
