...
| 范式 | 人在哪 | 适用阶段 | 锚点 |
|------|--------|---------|------|
| **单 Agent 协作** | 驱动循环、随时介入 | 探索期、PoC | [Agent-Driven Debugging](/2026-03-12-agent-driven-debugging/) |
| **流程工具包** | 写流程，Agent 跑步骤 | 团队标准化 | [gstack vs Skills](/2026-03-21-gstack-vs-claude-code-skills/) |
| **技能库** | 设计能力，Agent 调用 | 工程纪律沉淀 | [agent-skills](/2026-06-27-agent-skills/) |
| **循环工程** | 设计循环本身 | 规模化、长期 | [Loop Engineering](/2026-06-27-loop-engineering/) |
...
**[Agent-Driven Debugging：从调试到诊断](/2026-03-12-agent-driven-debugging/)**
...
**[gstack vs Claude Code Skills：AI 编程的两种哲学](/2026-03-21-gstack-vs-claude-code-skills/)**
...
**[AI 编程代理的工程纪律：agent-skills 的反直觉设计](/2026-06-27-agent-skills/)**
...
**[Loop Engineering：把"你"从流程里抽出来](/2026-06-27-loop-engineering/)**
...
| 你的问题 | 范式 | 推荐入口 |
|---------|------|---------|
| "我想试试 AI 帮我写代码" | 单 Agent 协作 | [Agent-Driven Debugging](/2026-03-12-agent-driven-debugging/) |
| "团队需要统一的 AI 工作流" | 流程工具包 | [gstack vs Skills](/2026-03-21-gstack-vs-claude-code-skills/) |
| "我们的 skill 越来越乱" | 技能库 | [agent-skills](/2026-06-27-agent-skills/) |
| "我们要把 AI 部署到生产，每天自动跑" | 循环工程 | [Loop Engineering](/2026-06-27-loop-engineering/) |
...
1. [Agent-Driven Debugging](/2026-03-12-agent-driven-debugging/) — 单 Agent 协作范式
2. [gstack vs Claude Code Skills](/2026-03-21-gstack-vs-claude-code-skills/) — 流程工具包范式
3. [agent-skills 的反直觉设计](/2026-06-27-agent-skills/) — 技能库范式
4. [Loop Engineering](/2026-06-27-loop-engineering/) — 循环工程范式
