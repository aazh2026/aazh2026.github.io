...
```mermaid
flowchart TB
    Supervisor["Supervisor Agent"] --> Code["Code Agent"]
    Supervisor --> Test["Test Agent"]
    Supervisor --> Doc["Doc Agent"]
...
```mermaid
flowchart TB
    Dev["Dev Agent"] <--> Ops["Ops Agent"]
    Dev <--> QA["QA Agent"]
    Ops <--> PM["PM Agent"]
    
    style Dev fill:#dbeafe,stroke:#2563eb
    style Ops fill:#dbeafe,stroke:#2563eb
    style QA fill:#dbeafe,stroke:#2563eb
...
flowchart TB
    ...
    style CEO fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style Eng fill:#dbeafe,stroke:#2563eb
    style Biz fill:#dbeafe,stroke:#2563eb
    style HR fill:#dbeafe,stroke:#2563eb
    style Sub1 fill:#d1fae5,stroke:#059669
    style Sub2 fill:#d1fae5,stroke:#059669
    style Sub3 fill:#d1fae5,stroke:#059669
```
...
```mermaid
flowchart TB
    PM["产品经理（人类）<br/>工具：需求分析 Agent、竞品监控 Agent"]
    Dev["开发工程师（人类）<br/>工具：代码生成 Agent、测试 Agent"]
    Ops["运维工程师（人类）<br/>工具：监控 Agent、自动修复 Agent"]
    ...
    style Ops fill:#dbeafe,stroke:#2563eb,stroke-width:2px
```
...
flowchart TB
    subgraph PM["产品经理层"]
        PMA["产品经理 Agent"] <--> PMH["产品经理（人类）"]
    end
    
    subgraph Dev["开发层"]
        DevA["开发 Agent"] <--> DevH["开发工程师（人类）"]
    end
    
    PM --> Dev
    
    style PMA fill:#dbeafe,stroke:#2563eb
    style PMH fill:#fef3c7,stroke:#d97706,stroke-width:2px
    style DevA fill:#dbeafe,stroke:#2563eb
    style DevH fill:#fef3c7,stroke:#d97706,stroke-width:2px
```
...
```mermaid
flowchart TB
    Agent["客户成功 Agent（自主运行）<br/>- 自动监测客户健康度<br/>- 主动发起客户沟通<br/>- 升级复杂问题给人类"]
    Human["人类客户成功经理（监督角色）<br/>- 处理 escalations<br/>- 策略制定<br/>- 关系维护"]
    
    Agent --> Human
    
    style Agent fill:#dbeafe,stroke:#2563eb,stroke-width:2px
    style Human fill:#fef3c7,stroke:#d97706,stroke-width:2px
```
...
flowchart TB
    subgraph Matrix["决策矩阵"]
        ...
        subgraph LowComp["低复杂度"]
            A["Agent 自主处理"]
            B["Agent + 人类审核"]
        end
        
        subgraph HighComp["高复杂度"]
            C["Agent 辅助 人类决策"]
            D["人类主导 Agent 支持"]
        end
    end
