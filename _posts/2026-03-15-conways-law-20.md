...
<object data="/assets/images/2026-03-15-conways-law-01-structure.svg" type="image/svg+xml" width="100%" aria-label="插图" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-02-comparison.svg" type="image/svg+xml" width="100%" aria-label="为什么需要 2.0？（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-01-supervisor.svg" type="image/svg+xml" width="100%" aria-label="拓扑 A：中心化（Hub-and-Spoke）（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-02-peers.svg" type="image/svg+xml" width="100%" aria-label="拓扑 B：点对点（P2P）（插图）" role="img"></object>

**适用场景**：Agent 之间需要频繁协作，任务边界模糊

#### 拓扑 C：分层（Hierarchical）

<object data="/assets/images/2026-03-15-conways-law-03-hierarchy.svg" type="image/svg+xml" width="100%" aria-label="拓扑 C：分层（Hierarchical）（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-04-pipeline.svg" type="image/svg+xml" width="100%" aria-label="模式 1：Agent 增强型（Agent-Augmented）（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-05-hybrid.svg" type="image/svg+xml" width="100%" aria-label="模式 2：人机协作型（Human-Agent Pair）（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-06-agent-first.svg" type="image/svg+xml" width="100%" aria-label="模式 3：Agent 主导型（Agent-First）（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-conways-law-07-matrix.svg" type="image/svg+xml" width="100%" aria-label="职责划分的三个原则（插图）" role="img"></object>
---
...
<object data="/assets/images/2026-03-15-conways-law-08-arch.svg" type="image/svg+xml" width="100%" aria-label="案例：Spotify Squad 如何变成 Agent 拓扑（插图）" role="img"></object>
