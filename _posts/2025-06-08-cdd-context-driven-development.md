...
<object data="/assets/images/2025-06-08-cdd-01-lifecycle.svg" type="image/svg+xml" width="100%" aria-label="上下文的生命周期（插图）" role="img"></object>

<object data="/assets/images/2025-06-08-cdd-01-cycle.svg" type="image/svg+xml" width="100%" aria-label="上下文的生命周期（插图）" role="img"></object>
...
<object data="/assets/images/2025-06-08-cdd-02-layer-arch.svg" type="image/svg+xml" width="100%" aria-label="三层上下文模型（插图）" role="img"></object>
...
<object data="/assets/images/2025-06-08-cdd-03-system-arch.svg" type="image/svg+xml" width="100%" aria-label="上下文管理系统：工程化的刚需（插图）" role="img"></object>
