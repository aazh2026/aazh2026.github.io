...
<object data="/assets/images/2026-03-16-xml-dsl-01-lisp-xml-isomorphism.svg" type="image/svg+xml" width="100%" aria-label="DSL 的本质是什么？（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-16-xml-dsl-02-format-comparison.svg" type="image/svg+xml" width="100%" aria-label="XML vs JSON/YAML：场景选择指南" role="img"></object>
