...
<object data="/assets/images/2025-02-03-ai-tech-frontier-01-ai-collaboration.svg" type="image/svg+xml" width="100%" aria-label="意义（插图）" role="img"></object>
...
<object data="/assets/images/2025-02-03-ai-tech-frontier-02-cognitive-debt.svg" type="image/svg+xml" width="100%" aria-label="关键概念：认知债务 (Cognitive Debt)（插图）" role="img"></object>
...
<object data="/assets/images/2025-02-03-ai-tech-frontier-03-remote-control.svg" type="image/svg+xml" width="100%" aria-label="与 OpenClaw 的竞争（插图）" role="img"></object>
