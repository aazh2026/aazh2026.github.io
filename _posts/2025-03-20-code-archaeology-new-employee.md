...
> 💡 **Key Insight**
>
> **关键人员离职造成知识集中流失**——这是业界反复观察到的现象，[Stack Overflow 2024 Developer Survey](https://survey.stackoverflow.co/2024/) 与 [Stripe Engineering Blog 关于组织记忆的讨论](https://stripe.com/blog/engineering) 多次提到"关键人离开 → 知识盲区"的结构性风险。具体比例（如"87% 的支付网关知识"）是**叙事性数字**，用以表达"知识过度集中在少数人身上"的问题，不应作为可核实的事实陈述；真实场景中的比例应通过内部知识图谱或贡献度统计来测量。

当王工离职时，他带走了大量未外化的隐性知识——那些注释、那些 TODO、那些"临时方案"，都是他大脑的外部存储。一旦存储介质失效，剩下的只有一堆无法解析的比特。
...
*Published on 2025-03-20 | 阅读时间：约 15 分钟*
