...
>
> 本文核心观点：
> 1. **Brooks 的框架依然有效** — 软件复杂性分为本质复杂度（问题本身）和偶然复杂度（工具引入），AI 擅长消除后者，但无法触及前者。
> 2. **AI 引入了新的复杂度** — 认知分裂（在 AI 输出与自身理解之间反复校准）、验证负担（每行 AI 代码都需要审查）、信任校准（什么时候该信，什么时候该质疑）。
...
<img src="/assets/images/2026-03-15-software-complexity-01-ai-complexity-types.svg" alt="2026-03-15-software-complexity-01-ai-complexity-types 图示" width="100%" loading="lazy" decoding="async">

<img src="/assets/images/2026-03-15-software-complexity-02-complexity-taxonomy.svg" alt="2026-03-15-software-complexity-02-complexity-taxonomy 图示" width="100%" loading="lazy" decoding="async">
...
> 💡 **Key Insight**
>
> 过去几十年的进步大多消除了偶然复杂度，但本质复杂度依然如故——这也是我们从未看到生产力数量级跃升的原因。
...
> 💡 **Key Insight**
>
> AI 可以帮你写代码，但它不能帮你决定写什么代码，更不能帮你决定不写什么代码——而后者往往是更重要的。
...
> 💡 **Key Insight**
>
> AI 辅助的开发曲线是跳跃的：你可能突然拥有 1000 行"工作"的代码，但你的理解还停留在第 100 行。
...
<img src="/assets/images/2026-03-15-software-complexity-03-complexity-transformation.svg" alt="7.4 复杂性的守恒定律" width="100%" loading="lazy" decoding="async">

> 💡 **Key Insight**
>
> AI 没有消除复杂性总量，只是将它从一种形式转化为另一种形式——写代码的复杂性转化为验证代码的复杂性，记忆的复杂性转化为理解的复杂性。
...
AI 不是银弹，但它是**一把更锋利的剑**。剑本身不能战胜复杂性，但持剑人的能力会被放大。
