...
>
> 本文核心观点：
> 1. **Clean Room 的本质是信息隔离** — 传统 Clean Room 通过物理隔离墙确保实现者从未接触原始代码，从而规避版权风险
> 2. **AI 的介入颠覆了 Clean Room 的前提** — AI 没有"接触"代码的概念，它的"独立实现"本质上是训练记忆中的模式重组
...
- [Compaq and the IBM PC Compatible: The Story of the Clean Room](https://www.pcmag.com/news/compaq-cloned-ibm-bios-the-true-story)
