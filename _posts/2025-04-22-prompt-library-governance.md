...
<object data="/assets/images/2025-04-22-prompt-library-01-governance.svg" type="image/svg+xml" width="100%" aria-label="治理的五个维度（插图）" role="img"></object>
<object data="/assets/images/2025-04-22-prompt-library-02-lifecycle.svg" type="image/svg+xml" width="100%" aria-label="治理的五个维度（插图）" role="img"></object>
