...
description: "ADR是架构决策的时间胶囊——记录'为什么这样选'而非'选了什么'，让后来者看到完整决策上下文。KBaaC将架构决策、编码规范、运行手册全部纳入Git管理，通过PR流程驱动知识演进，实现知识与代码共生。"
author: "@postcodeeng"
...
<object data="/assets/images/2025-03-03-knowledge-base-as-code-02-kbac-pillars.svg" type="image/svg+xml" width="100%" aria-label="KBaaC 三大支柱：ADR / 编码规范 / 运行手册" role="img"></object>
...
<object data="/assets/images/2025-03-03-knowledge-base-as-code-01-adr-lifecycle.svg" type="image/svg+xml" width="100%" aria-label="ADR 状态流转图" role="img"></object>
