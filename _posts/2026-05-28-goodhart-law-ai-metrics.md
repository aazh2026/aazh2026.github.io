...
回到 1975 年那条 Goodhart 定律，AI 时代的版本比原版更残酷：**不是因为我们选错了指标，而是真正有价值的指标在结构上就无法被采集**——这是工程管理面对的元问题，比 Goodhart 当年讨论的货币政策更难回避。

当生成代码的成本趋近于零，组织会本能地去衡量容易衡量的东西，但最容易衡量的活动往往最没有价值。摆脱这种困境的方式不是寻找更复杂的指标，而是承认判断力本身就是产出的一部分，而判断力是无法被外部 KPI 化的。

这意味着：AI 时代的工程管理，最终是一场关于"什么不被衡量"的决定——而那些不可衡量的部分，往往正是组织竞争力的真正所在。

> 💡 **Key Insight**
>
> AI 时代工程管理的真正挑战，不是去找更好的指标，而是承认最有价值的部分在结构上无法被衡量——并据此重新组织团队与激励。
