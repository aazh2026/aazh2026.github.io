...
> **TL;DR**
> - OpenClaw 是一家获得 18,000 GitHub Stars 的开源项目，其"swarm consensus"架构代表了 AI Agent 从"听话的助手"到"自驱的参与者"的范式转变
> - 核心创新：网状共识架构取代树状控制，模糊意图解析取代精确指令，对抗性安全取代中心化审核
...
> 💡 **Key Insight**
>
> OpenClaw的定位：OpenClaw不是在构建"更好的ChatGPT"，而是在构建"AI的数字劳动力市场"。
...
<img src="/assets/images/2025-02-25-swarm-01-hierarchy.svg" alt="OpenAI的&quot;树状控制&quot;模型" width="100%" loading="lazy" decoding="async">
<img src="/assets/images/2025-02-25-swarm-02-p2p.svg" alt="OpenAI的&quot;树状控制&quot;模型" width="100%" loading="lazy" decoding="async">
**结算**：
...
> 💡 **Key Insight**
>
> AI学会如何理解人类的目标——但这带来了新的风险：当AI开始自己决定"怎么做"时，如何确保它不会做出危险的决定？
...
- [Trustless Handoff Protocol Whitepaper](https://openclaw.ai/whitepapers/trustless-handoff) — OpenClaw 官方协议白皮书，详述 Agent 之间的无需信任交接机制
- [Swarm Intelligence in Multi-Agent Systems - Research Paper](https://arxiv.org/abs/2308.12348) — Dor Sevt et al., arXiv 2023, 多 Agent 系统中的群体智能综述
- [@steipete (Peter Steinberger)'s Architecture Thread](https://x.com/steipete/status/1889475237299589321) — OpenClaw 创始人关于 swarm consensus 设计决策的原始推文串
- [Adversarial Safety in Decentralized AI - arXiv](https://arxiv.org/abs/2501.13001) — 2025 年 arXiv 论文，分析去中心化 AI 网络中的对抗性安全挑战
