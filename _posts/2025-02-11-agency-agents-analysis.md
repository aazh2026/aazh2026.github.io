...
>
> 本文核心观点：
> 1. **多Agent组织化** — agency-agents不是追求更强的单Agent，而是构建带个性、流程和交付物的多Agent协作组织
> 2. **角色优于流程** — 基于角色的编排比基于流程的编排更适合复杂、探索性的项目
> 3. **结构化交付物** — 每个Agent产出结构化交付物（代码/文档/设计/数据），而非自由文本，确保可验证、可组合、可追溯
> 4. **工程化挑战** — 规模扩展、动态角色演化、学习机制和成本控制是仍未解决的开放问题
...
<img src="/assets/images/2025-02-11-agency-agents-02-collaboration-flow.svg" alt="多Agent协作的工作流" width="100%" loading="lazy" decoding="async">

项目的快速增长（单日+2,209 stars）反映了市场的强烈需求。开发者们已经意识到：Agentic Engineering的下一步不是 bigger model，而是 better orchestration。

> 💡 **Key Insight**
>
> Agentic Engineering的下一步不是 bigger model，而是 better orchestration。
...
<img src="/assets/images/2025-02-11-agency-agents-01-role-architecture.svg" alt="核心架构图：角色编排 vs 流程编排" width="100%" loading="lazy" decoding="async">
...
<img src="/assets/images/2025-02-11-agency-agents-03-three-pillars.svg" alt="agency-agents 三大工程机制" width="100%" loading="lazy" decoding="async">
...
- [agency-agents GitHub Repository](https://github.com/agency-agents/agency-agents)
- [CrewAI Documentation](https://docs.crewai.com/)
- [Multi-Agent Systems: A Survey](https://arxiv.org/abs/2308.11432) — arXiv 综述，覆盖多Agent系统的核心概念与架构模式
- [Organizational Design for AI Teams](https://hbr.org/2024/07/designing-ai-driven-organizations) — Harvard Business Review 关于人机混合团队的组织的分析
- [The Future of Work: AI Coworkers](https://www.mckinsey.com/featured-insights/mckinsey-explainers/what-is-the-future-of-work) — McKinsey 对 AI 协作趋势的追踪报告
...
*Published on 2025-02-11 | 阅读时间：约 12 分钟*