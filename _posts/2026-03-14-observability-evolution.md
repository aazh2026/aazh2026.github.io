...
<img src="/assets/images/2026-03-14-observability-evolution-01-arch.svg" alt="AI-Native 可观测性系统架构图" width="100%" loading="lazy" decoding="async">

### 三层可观测性模型

各层的具体职责和组件如下：

<img src="/assets/images/2026-03-14-observability-evolution-02-three-layers.svg" alt="三层可观测性模型" width="100%" loading="lazy" decoding="async">
