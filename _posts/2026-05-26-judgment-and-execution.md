...
> **TL;DR**
>
> Anthropic 工程团队的系列文章揭示了一个核心原则：AI 编程的正确姿势不是"让它写代码"，而是"让它写代码，然后找另一个 AI 来挑错"。这不是 AI 的 bug，而是智能系统设计的核心原则——judgment 和 execution 必须分离。单模型无法可靠评判自己的工作；多模型交叉审查更可靠；慢一点写更好的代码不是因为 AI 不够好，而是因为**距离感是正确判断的前提**。
