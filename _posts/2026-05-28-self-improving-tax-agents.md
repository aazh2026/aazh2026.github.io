...
<object data="/assets/images/2026-05-28-self-improving-tax-agents-01-feedback-loop.svg" type="image/svg+xml" width="100%" aria-label="自我改进税务 Agent 反馈循环" role="img"></object>
...
> 💡 **Key Insight**
>
> 7000 份申报单不是背景数字——它们是 7000 个结构性信号的生产者。每次从业者的纠正都在为系统提供学习素材。
...
> 💡 **Key Insight**
>
> 生产即评估的核心不是「生产环境比实验室更真实」，而是**生产环境能产生带完整上下文标签的训练数据**——每一条从业者纠正都同时是一个信号和一个答案。
...
> 💡 **Key Insight**
>
> 从业者纠正 → 结构化 traces → eval targets，这条管道把人的判断力转化成了可测量的工程任务。没有这条管道，纠正只是噪音；有了这条管道，纠正就变成了 Codex 每次运行都要爬的那座山。

### Finding 成为 Codex 要爬的山
...
Tax AI 案例中最重要的不是 7000→86% 这个数字本身，而是它示范了一种设计哲学：**让生产环境本身成为持续改进的引擎**。这个哲学可以迁移到任何"高频纠错"的工作流：法律文档审查、医疗编码、IT help desk、合同抽取。

把"人工纠正"转化为"工程任务"是 AI 产品走向成熟的分水岭。在大多数 AI 产品里，从业者的干预是产品改进的终点——它们消失在工单和邮件里；在 Tax AI 里，每次纠正都是一条被结构化、有上下文、有追溯的信号，等待 Codex 爬上一座已经被清晰标记的山。这让 AI 产品的迭代速度不再由"工程师手动分类问题"决定，而由"生产信号密度"决定。

那位会计师节省的 165 小时是这个工程哲学的最好注脚：当 AI 把人从低价值工作中释放出来，剩下的时间会自然流向高价值工作——而高价值工作往往恰恰是让 AI 变得更好的信号来源。这是一个正循环。

> 💡 **Key Insight**
>
> Tax AI 教给我们的是：AI 产品成熟的标志不是"模型变强"，而是"生产信号变成结构化反馈循环"。这才是评估驱动开发（EDD）在 AI 时代的具体形态。
