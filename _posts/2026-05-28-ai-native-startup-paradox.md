...
>
> 本文核心观点：
> 1. **Brooks 框架依然适用** — 本质复杂度不可消除，AI 消除的只是偶发复杂度
> 2. **执行与判断的分离** — AI 让执行变得容易，但判断变成新的瓶颈，且密度比以前高出数个数量级
> 3. **元技能的稀缺性** — 核心技能从"知道该做什么"变成"知道什么值得知道"，后者只能靠第一手经验积累
> 4. **判断力是真正的护城河** — 执行能力变成商品后，差异化的唯一来源是对行业的深度浸入式理解

<object data="/assets/images/2026-05-28-ai-native-startup-paradox-01-brooks-framework.svg" type="image/svg+xml" width="100%" aria-label="2026-05-28-ai-native-startup-paradox-01-brooks-framework 图示" role="img"></object>
...
<object data="/assets/images/2026-05-28-ai-native-startup-paradox-02-judgment-density.svg" type="image/svg+xml" width="100%" aria-label="执行与判断的分离" role="img"></object>
