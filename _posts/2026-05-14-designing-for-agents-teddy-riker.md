...
<object data="/assets/images/2026-05-14-designing-for-agents-teddy-riker-02-double-agent-flow.svg" type="image/svg+xml" width="100%" aria-label="新交互模式（插图）" role="img"></object>

## 教 Agent 如何成功

<object data="/assets/images/2026-05-14-designing-for-agents-teddy-riker-01-interaction-layers.svg" type="image/svg+xml" width="100%" aria-label="为 Agent 设计：交互模式演进" role="img"></object>
...
> 💡 **Key Insight**
>
> 设计良好的 Agent 交互翻转了这个——它不问 GL 代码，它问 context：这是客户用餐、团队用餐还是个人旅行？
...
> 💡 **Key Insight**
>
> Ramp 的数据：过去三个月里，Ramp MCP 的周活跃用户增长了 10 倍，这直接来自 Agent 对 Agent 的交互。
...
> 💡 **Key Insight**
>
> 突然你有了 Agent 告诉你的 Agent 该构建什么——rationale logs 是新功能发现的核心信号。
...
**本系列相关**
- [Harness Engineering：AI Agent 时代真正的工程竞争在 scaffold 层](https://aazh2026.github.io/posts/loop-engineering) (AI-Native Engineering)
- [Perplexity 官方指南：Skill 的 Zen of Python 对比，和一个反直觉的研究结论](https://aazh2026.github.io/posts/perplexity-skills) (AI-Native Engineering)
- [Claude Skills 完整指南：把一次性 prompt 变成可积累的工作流资产](https://aazh2026.github.io/posts/claude-skills-guide) (AI-Native Engineering)
