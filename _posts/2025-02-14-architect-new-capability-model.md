...
>
> 本文核心观点：
> 1. **角色迁移** — AI时代，架构师从"画架构图的人"进化为"设计Context的人"，从执行层跃迁到定义层
> 2. **π型能力模型** — 新能力模型由三部分构成：技术评估能力（左竖）、Context设计能力（右竖）、跨领域整合能力（横杠）
> 3. **Context设计五维度** — 问题定义、约束空间、协作协议、质量标准、演化路径，是AI时代架构师最核心的新增竞争力
> 4. **从执行到评估** — 技术深度从"我能做什么"转向"我能判断什么是对的"，评估能力取代执行能力成为核心

<img src="/assets/images/2025-02-14-architect-new-capability-model-01-pi-model.svg" alt="2025-02-14-architect-new-capability-model-01-pi-model 图示" width="100%" loading="lazy" decoding="async">
...
> **2024 年某头部互联网公司的内部实验**（具体来源未公开，业界观察常引用为代表性场景）：让 GPT-4 与资深架构师分别设计同一微服务系统的架构方案。实验**业界共识级观察**是：LLM 在常规架构模式与已知最佳实践下能产出可用的初稿方案，在**多云成本对比、API 选型、模板化代码生成**等结构化决策上具有速度优势；但在**领域特定权衡、组织约束映射、长期演化路径**等方面仍依赖人类判断。结论应理解为"互补"，而非"取代"。
...
> 💡 **Key Insight**
>
> AI取代的是架构师的"执行角色"，而非架构师的"设计角色"——价值从"做"迁移到"判断什么值得做"。
...
> 💡 **Key Insight**
>
> Context设计不是"更抽象的架构"，而是"定义AI和人类的工作边界"——这是AI时代架构师独有的价值定位。

### 什么是Context设计？

Context设计（Context Design）是指：**为AI和人类团队定义工作的边界、约束和协作规则**。

<img src="/assets/images/2025-02-14-architect-new-capability-model-02-context-design.svg" alt="什么是Context设计？" width="100%" loading="lazy" decoding="async">
...
> 💡 **Key Insight**
>
> AI擅长在约束空间内优化，但无法自主定义这个空间——问题框架化是Context设计师不可替代的核心能力。
...
> 💡 **Key Insight**
>
> 从T型到π型不是"加一条能力"，而是重心的根本转移——技术深度从"我能做什么"转向"我能判断什么是对的"。
...
> 💡 **Key Insight**
>
> Context设计的五个维度不是"检查清单"，而是架构师与AI之间的分工协议——决定哪些由人做、哪些由AI做、哪些共同做。
...
> 💡 **Key Insight**
>
> 跨领域整合的终极目标是在技术、业务、组织之间建立"共同语言"——让每个领域理解其他领域的约束和目标。
...
> 💡 **Key Insight**
>
> Context设计的质量不在于文档的完整性，而在于它是否能让AI和团队都清楚"什么该做、什么不该做"。
...
> 💡 **Key Insight**
>
> 架构师的终极价值不在于掌握什么技术，而在于定义"什么是好"——随着AI承担执行角色，这个定义权的含金量只会越来越高。
...
- [Architecting for AI - Martin Fowler](https://martinfowler.com/articles/architecting-for-ai.html)
- [Team Topologies - Matthew Skelton](https://teamtopologies.com/)
- [Building Evolutionary Architectures - Neal Ford](https://www.thoughtworks.com/insights/books/building-evolutionary-architectures)
- [The Architect Elevator - Gregor Hohpe](https://architect-elevator.com/)
- [Staff Engineer - Will Larson](https://staffeng.com/)

---

*Published on 2025-02-14 | 阅读时间：约 18 分钟*
