...
<object data="/assets/images/2026-03-16-preflight-validator-01-check-flow.svg" type="image/svg+xml" width="100%" aria-label="核心原则（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-16-preflight-validator-02-shift-left.svg" type="image/svg+xml" width="100%" aria-label="结尾：左移 ML 工程（插图）" role="img"></object>
