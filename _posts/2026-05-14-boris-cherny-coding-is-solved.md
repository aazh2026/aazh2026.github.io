...
<object data="/assets/images/2026-05-14-boris-cherny-coding-is-solved-01-spectrum.svg" type="image/svg+xml" width="100%" aria-label="2026-05-14-boris-cherny-coding-is-solved-01-spectrum 图示" role="img"></object>
...
Boris 借用了 Hamilton Helmer 的"Seven Powers"框架回答，用两个维度把护城河分成四类：
...
如果有，Boris 的印刷术类比就从修辞变成事实。印刷术的历史先例是：谷登堡之后几十年里，最成功的书商不是原来会拉丁语的僧侣，而是懂得用新工具批量生产的商人——他们不懂印刷，但懂市场。AI 编程的对应物是一个懂供应链、懂合规、懂用户，但完全不需要懂代码的创始人。他用 Claude Code 从零搭起整个技术栈，融资、上市、规模化。

什么样的证据算是"有"？公开的创始人声明 + 技术架构文档 + 外部审计或媒体报道，不是内部工具或概念验证。需要满足几个条件：公司估值超过 10 亿美元、创始人背景有据可查（非工程出身）、核心技术栈由 Claude Code 或同类工具构建、有外部第三方确认。这个门槛设计得严格，是因为松散的"我们在用 AI 写代码"不算数——必须是自建全部技术栈且不依赖工程师这个判断才成立。

如果两年内没有这样的公司出现，说明几个可能的原因：企业级采购的合规门槛比预期更慢；非技术创始人对 AI 编程的信任建立需要更长时间；或者 Claude Code 本身在非主流技术栈上的表现还不足以支撑全栈自建。无论哪一种，都意味着 Boris 的"编程已被解决"判断的普及时间表要往后推——不是对错问题，是时机问题。

---

## 参考来源

- [红杉资本 AI Ascent 2026 大会完整访谈](https://www.youtube.com/watch?v=SlGRN8jh2RI)，Boris Cherny 与 Lauren对谈
- Hamilton Helmer《7 Powers》：七种可持续竞争优势框架
- Loop/Routines：Anthropic 的 Agent 调度产品
- Fortune 报道：[Anthropic 内部代码 100% 由模型生成](https://fortune.com/2026/01/29/100-percent-of-code-at-anthropic-and-openai-is-now-ai-written-boris-cherny-roon/)，2026 年 1 月