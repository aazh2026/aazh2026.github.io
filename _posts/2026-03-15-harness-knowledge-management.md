...
<object data="/assets/images/2026-03-15-harness-knowledge-mgmt-01-encyclopedia.svg" type="image/svg+xml" width="100%" aria-label="从百科全书到地图（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-harness-knowledge-management-02-repo-structure.svg" type="image/svg+xml" width="100%" aria-label="知识库的系统架构（插图）" role="img"></object>
