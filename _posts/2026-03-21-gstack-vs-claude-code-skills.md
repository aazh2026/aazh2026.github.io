...
<object data="/assets/images/2026-03-21-gstack-vs-claude-code-skills-02-arch.svg" type="image/svg+xml" width="100%" aria-label="核心理念（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-21-gstack-vs-claude-code-skills-03-arch.svg" type="image/svg+xml" width="100%" aria-label="关键特性（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-21-gstack-vs-claude-code-skills-04-arch.svg" type="image/svg+xml" width="100%" aria-label="关键特性（插图）" role="img"></object>
