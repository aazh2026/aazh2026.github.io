...
<img src="/assets/images/2026-03-18-kimi-attention-residuals-01-residual-comparison.svg" alt="Standard Residual vs Attention Residuals" width="100%" loading="lazy" decoding="async">

*图 1：Standard Residual（❌）使用固定权重（=1.0）的加法残差连接，所有层贡献均等；Attention Residual（✅）通过注意力机制动态决定各层的聚合权重，实现选择性层聚合。*

<img src="/assets/images/2026-03-18-kimi-attention-residuals-02-layer-aggregation.svg" alt="层聚合方式对比与 Block AttnRes" width="100%" loading="lazy" decoding="async">
