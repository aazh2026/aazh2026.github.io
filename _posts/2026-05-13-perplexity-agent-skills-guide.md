...
<object data="/assets/images/2026-05-13-perplexity-agent-skills-guide-01-context-cost.svg" type="image/svg+xml" width="100%" aria-label="Zen of Python vs Zen of Skills" role="img"></object>
...
<object data="/assets/images/2026-05-13-perplexity-agent-skills-guide-02-skill-folder.svg" type="image/svg+xml" width="100%" aria-label="Skill 是一个目录" role="img"></object>
