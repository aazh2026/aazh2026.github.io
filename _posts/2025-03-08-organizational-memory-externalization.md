...
>
> 本文核心观点：
> 1. **隐性知识流失** — 组织最大的风险不是知识太少，而是那些无法文档化的"活历史"随专家离职而蒸发
> 2. **AI 捕获范式** — 从"让专家写下来"转变为"在专家工作时自动捕获"，核心是捕获成本趋近于零
> 3. **知识冰山** — 业界普遍引用的"显性知识 ~10%、隐性知识 ~90%"是来自野中与竹内经典的近似比值，实际比例因行业、组织成熟度、岗位性质差异很大；本文沿用此行业共识作为讨论起点。
> 4. **组织记忆** — 唯一难以复制的是组织知识——那些深藏在集体经验中的智慧，它决定了一家公司的长期竞争力
...
管理学大师**野中郁次郎**（Ikujiro Nonaka）在 1995 年的开创性论文《The Knowledge-Creating Company》中提出：知识分为显性和隐性（[Nonaka & Takeuchi, *The Knowledge-Creating Company*](https://www.amazon.com/Knowledge-Creating-Company-Ikujiro-Nonaka/dp/0195092694)）。
...
框架、工具、最佳实践的更新周期通常被业界共识表述为"每 18 个月"级别（"18 个月周期"常被追溯到 [Moore's Law 经验观察](https://en.wikipedia.org/wiki/Moore%27s_law)），但具体到不同领域有显著差异——这一数字用于说明"经验衰减加速"的趋势，不应作为硬性时间表。

但**元经验**——如何学习新技术、如何判断技术趋势、如何在不确定性中做决策——是持久的。

**原因二：人员流动加剧**

Remote work、跳槽文化、创业浪潮——员工平均任职时间因行业和地区差异极大（美国劳工统计局 [BLS](https://www.bls.gov/) 的 Employee Tenure Summary 通常报告科技行业中位任期 3-5 年区间，传统行业更长），本文中"从 10 年降到 3 年"是常见趋势性描述，不是绝对数。
