...
redirect_from:
  - /2025-05-12-aise-framework-theory
---

> **TL;DR**
>
> AISE（AI-Native Software Engineering）是一个全新的软件工程范式：
> 1. **核心理念** — 从"代码优先"到"意图优先"，代码是意图的编译产物
...
人机协作并非简单的"AI做事、人监督"二元关系。根据任务特征和决策复杂度，AISE定义了四种协作模式，适用于不同场景：

**AI辅助（AI-Assisted）** — AI提供建议和候选方案，人类负责最终决策和执行。适用于架构设计、复杂业务规则定义等需要价值判断的场景。人类保持对结果的完全所有权。

**AI协作（AI-Collaborative）** — 人类和AI共同完成任务，双方深度参与各阶段。适用于代码审查、设计迭代等需要反复沟通的场景。AI不是工具，而是协作者。

**AI代理（AI-Agentic）** — AI在明确边界内自主完成任务全流程，人类保留监督和干预权限。适用于标准化流程、重复性任务（如代码格式化、测试生成、文档更新）。关键在于边界设定和异常升级机制。

**AI主导（AI-Dominant）** — AI负责任务执行和常规决策，人类提供高层次意图指导和结果验收。适用于大规模代码生成、探索性技术研究等AI擅长且效率差异显著的场景。

选择哪种模式，取决于三个维度：**任务复杂度**（高=需要更多人类判断）、**决策风险**（高=需要人类授权）、**AI能力成熟度**（成熟=可以给AI更多自主权）。四种模式不是升级路径，而是并列选项，同一项目不同子任务可能同时运行不同模式。

---

> 💡 **Key Insight**
>
> 人类和AI各有优势，最佳模式是协作而非替代
...
<img src="/assets/images/2025-05-12-aise-framework-01-layers.svg" alt="五层架构" width="100%" loading="lazy" decoding="async">
...
<img src="/assets/images/2025-05-12-aise-framework-02-maturity-model.svg" alt="Level 5：自主（Autonomous）" width="100%" loading="lazy" decoding="async">
