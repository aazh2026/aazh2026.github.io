...
>
> 本文核心观点：
> 1. **事故根源** — 3行代码的 int→long 变更，因破坏 protobuf 数据契约导致数百万交易失败，文本对比却显示"安全"
> 2. **认知盲区** — 文本对比基于1970年代的假设，无法发现语义破坏、跨文件依赖和契约违反
> 3. **三层能力** — AST级对比理解结构、意图分析理解动机、影响图分析理解涟漪效应，三层递进超越文本
> 4. **范式转变** — 语义Diff不是工具升级，是从"比较文本"到"理解意义"的信息表示革命
...
> 💡 **Key Insight**
>
> 代码变更的破坏力与变更的文本量不成正比——灾难往往藏在最小的改动里，而文本对比对此毫无察觉。
...
> 💡 **Key Insight**
>
> 事后追责容易，但真正的问题在于我们用文本对比作为代码审查的主要手段——工具的局限性决定了我们能发现的问题的边界。
...
> 💡 **Key Insight**
>
> 文本对比只能看见"文本改变了什么"，而语义Diff能回答"系统行为实际改变了什么"——这两者之间的鸿沟，正是生产事故的隐藏通道。
...
> 💡 **Key Insight**
>
> 文本对比看见的是代码的字面改变，语义Diff看见的是代码的行为改变——这正是为什么f-string和原始字符串在功能上等价，但安全性天差地别。
...
> 💡 **Key Insight**
>
> 每次载体升级都重新定义"比较"的含义——手抄时代比字、印刷时代比版、数字时代比行、AI时代比语义。语义Diff是AI时代的必然产物，不是可选项。
...
> 💡 **Key Insight**
>
> 从手抄到印刷到数字，每一次信息载体的升级都重新定义了"比较"的意义——AI时代语义Diff是必然，不是选择。

---

## 反直觉洞察：语义Diff的三层能力

<object data="/assets/images/2025-04-24-semantic-diff-01-layers.svg" type="image/svg+xml" width="100%" aria-label="反直觉洞察：语义Diff的三层能力（插图）" role="img"></object>

语义Diff（Semantic Diff）不是简单的工具升级，是范式的转变。

> 💡 **Key Insight**
>
> 语义Diff的三层能力不是递进替代，而是叠加——AST层看见结构，Intent层理解动机，Impact层评估涟漪，三层合在一起才是完整的语义理解。
...
> 💡 **Key Insight**
>
> AST层对比是语义Diff的起点——它看见的是文本看不见的结构，但仍然不知道"为什么改变"。
