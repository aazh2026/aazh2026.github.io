...
description: "量化验证CLAUDE.md规则效果：41%错误率（无规则）→3%（4条规则），4→12条合规率几乎不降但覆盖更多失败模式，超过14条规则开始崩。"
author: "@postcodeeng"
...
<object data="/assets/images/2026-05-12-karpathy-4-rules-to-12-rules-01-metrics-comparison.svg" type="image/svg+xml" width="100%" aria-label="数据驱动的方法（插图）" role="img"></object>
