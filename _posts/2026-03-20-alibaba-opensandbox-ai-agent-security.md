...
<object data="/assets/images/2026-03-20-alibaba-opensandbox-ai-agent-security-01-arch.svg" type="image/svg+xml" width="100%" aria-label="核心能力（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-20-alibaba-opensandbox-ai-agent-security-02-security-layers.svg" type="image/svg+xml" width="100%" aria-label="架构解析：三层安全模型（插图）" role="img"></object>
