...
<img src="/assets/images/2026-03-13-ai-native-code-review-01-jury-model.svg" alt="Agent 陪审团模型" width="100%" loading="lazy" decoding="async">
*图 1：Agent 陪审团模型——5 个专业 Agent 并行审查 PR，最终汇总为 Review Report，由人类审查者做最终设计判断。Agent 处理 80% 标准化检查，人类专注 20% 架构与设计决策。*

<img src="/assets/images/2026-03-13-ai-native-code-review-02-jury-flow.svg" alt="Agent 陪审团审查流程" width="100%" loading="lazy" decoding="async">
