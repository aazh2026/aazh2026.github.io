...
<object data="/assets/images/2026-05-13-claude-skills-complete-guide-01-lifecycle.svg" type="image/svg+xml" width="100%" aria-label="四阶段流程（插图）" role="img"></object>
...
<object data="/assets/images/2026-05-13-claude-skills-complete-guide-02-compound-interest.svg" type="image/svg+xml" width="100%" aria-label="结尾：Skill 库是复利（插图）" role="img"></object>
...
**本系列相关**
- [Skillify：如何让 AI Agent 不再犯同样的错误]({% post_url 2026-03-15-elegant-engineering %}) (AI-Native Engineering)
- [Harness Engineering：AI Agent 时代真正的工程竞争在 scaffold 层]({% post_url 2026-05-13-harness-engineering-addy-osmani %}) (AI-Native Engineering)
- [执行已死，判断力永生]({% post_url 2026-05-11-execution-is-dead-judgment-lives %}) (AI-Native Engineering)
