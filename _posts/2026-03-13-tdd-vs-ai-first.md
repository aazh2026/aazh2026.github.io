...
在经典 TDD 流程中，开发者先为注册功能编写一个失败的测试，再逐步实现代码使其通过。

### AI-First 方式

在 AI-First 流程中，开发者先用自然语言描述注册场景的意图，再由 AI 生成完整的测试矩阵。
...
### 实践
在此阶段，团队开始尝试用自然语言描述测试意图，逐步替代直接编写测试代码的方式。
...
### 实践
在此阶段，AI 可以根据意图描述自动生成测试代码的初稿，人类只需审查和调整。

### 阶段 3：意图驱动开发 (1-2 个月)

**目标**：意图成为主要工件，测试代码自动衍生

**系统**：意图文档成为核心工件，测试代码作为衍生品自动维护。
...
**CI/CD 集成**：在持续集成流程中，意图变更自动触发测试矩阵的更新和验证。
