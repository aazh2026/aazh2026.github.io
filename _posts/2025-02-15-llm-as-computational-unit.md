...
>
> 本文核心观点：
> 1. **计算范式演进** — Software 1.0（确定性二进制）→ Software 2.0（概率性神经网络）→ Software 3.0（工程化的概率性），权重正在变成新的可计算单元
> 2. **核心挑战** — 神经网络缺乏形式化语义、组合性不透明、可验证性困境，但这些挑战可以通过工程化方法缓解
> 3. **Software 3.0 方法论** — 验证优先、模块化契约、思维链显式化、工具约束、持续对齐、人在回路——追求"足够的确定性"而非完美确定性
> 4. **实践验证** — 这些方法不是形式化方法，但在实践中证明了 Software 2.0 的可行性，Cursor Composer、Claude Artifacts、LangChain 链式架构都是具体案例
...
<img src="/assets/images/2025-02-15-llm-as-computational-unit-02-workflow.svg" alt="Software 3.0 验证工作流" width="100%" loading="lazy" decoding="async">
...
> 💡 **核心对照**
>
> Software 1.0 的五个特性（形式化语义、组合性、可验证性、可调试性、可移植性）构成了其工程化的基石。Software 2.0 在这五项上面临根本性挑战，但这些挑战可以通过工程化方法部分缓解。
...
> 💡 **Key Insight**
>
> 组合性在 Software 2.0 中是涌现式的而非透明的，这从根本上改变了系统设计的思路。
...
> 💡 **Key Insight**
>
> 工程化的可行性不依赖于形式化语义，而依赖于统计可靠性与人在回路的互补机制。
...
<img src="/assets/images/2025-02-15-llm-as-computational-unit-03-pillars.svg" alt="Software 3.0 工程化六大支柱" width="100%" loading="lazy" decoding="async">

---

## 等价性差异：Software 1.0 vs 2.0 vs 3.0

<img src="/assets/images/2025-02-15-llm-as-computational-unit-01-three-paradigms.svg" alt="等价性差异：Software 1.0 vs 2.0 vs 3.0" width="100%" loading="lazy" decoding="async">
...
> 💡 **Key Insight**
>
> Software 3.0 的本质是"足够的确定性"——在保持神经网络概率性能力的同时，通过工程化方法使其可工程化、可维护、可信任。
...
- [Formal Verification of Neural Networks](https://arxiv.org/abs/2208.14799) — 关于神经网络形式化验证的综述
- [Interpretability and Explainability in Machine Learning](https://arxiv.org/abs/2210.01889) — 可解释性研究的最新进展
- [Neurosymbolic AI: The Third Wave](https://arxiv.org/abs/2002.06178) — 神经符号AI的系统性综述
- [Agentic Engineering Patterns - Simon Willison](https://simonwillison.net/2025/Apr/19/agentic-engineering/) — Simon Willison 对 Agentic Engineering 的实践总结

---

*Published on 2025-02-15 | 阅读时间：约 15 分钟*
