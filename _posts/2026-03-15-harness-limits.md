...
tags: [AI-Native软件工程, Harness Engineering, Limits, Agent, Reality Check]
...
<img src="/assets/images/2026-03-15-harness-limits-01-carlini.svg" alt="Carlini 观察到的限制" width="100%" loading="lazy" decoding="async">
...
> 💡 **Key Insight**
>
> Harness 工程能可靠地执行**已知路径**的任务（构建、修复、实现），但无法代替人类走**未知路径**——这不是模型能力的问题，而是目标定义本身需要人类判断。
