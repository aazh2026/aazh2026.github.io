...
<object data="/assets/images/2025-04-15-execution-plan-ai-orchestration-01-wbs-four-layer.svg" type="image/svg+xml" width="100%" aria-label="四层任务拆解结构" role="img"></object>
...
<object data="/assets/images/2025-04-15-execution-plan-ai-orchestration-02-critical-path.svg" type="image/svg+xml" width="100%" aria-label="Execution Plan 依赖管理与关键路径" role="img"></object>
