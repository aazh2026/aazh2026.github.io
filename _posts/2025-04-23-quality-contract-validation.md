...
<object data="/assets/images/2025-04-23-quality-contract-validation-04-cost-curve.svg" type="image/svg+xml" width="100%" aria-label="测试滞后的代价（插图）" role="img"></object>
...
<object data="/assets/images/2025-04-23-quality-contract-01-stack.svg" type="image/svg+xml" width="100%" aria-label="四层契约体系（插图）" role="img"></object>
...
<object data="/assets/images/2025-04-23-quality-contract-02-pipeline.svg" type="image/svg+xml" width="100%" aria-label="契约即测试（插图）" role="img"></object>
...
<object data="/assets/images/2025-04-23-quality-contract-validation-03-ai-qc-loop.svg" type="image/svg+xml" width="100%" aria-label="AI 辅助契约生成（插图）" role="img"></object>
