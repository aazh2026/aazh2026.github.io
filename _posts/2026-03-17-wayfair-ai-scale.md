...
<object data="/assets/images/2026-03-17-wayfair-ai-scale-01-arch.svg" type="image/svg+xml" width="100%" aria-label="整体架构（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-17-wayfair-ai-scale-01-multi-language.svg" type="image/svg+xml" width="100%" aria-label="多语言架构（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-17-wayfair-ai-scale-02-quality-control.svg" type="image/svg+xml" width="100%" aria-label="三层质量控制（插图）" role="img"></object>
