...
<object data="/assets/images/2026-03-15-ai-native-data-engineering-00-ai-native-data-stack.svg" type="image/svg+xml" width="100%" aria-label="AI-Native 数据工程三层架构" role="img"></object>
...
<object data="/assets/images/2026-03-15-ai-native-data-engineering-02-self-healing-pipeline.svg" type="image/svg+xml" width="100%" aria-label="智能数据流水线：自愈、自适应、自优化（插图）" role="img"></object>
...
<object data="/assets/images/2026-03-15-ai-native-data-engineering-03-vector-mesh.svg" type="image/svg+xml" width="100%" aria-label="向量数据网格架构" role="img"></object>
